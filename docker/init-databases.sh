...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" --dbname "booking_db" <<-'EOSQL'
    ...
    INSERT INTO booking (user_id, service_id, company_id, start_time, end_time, price, status) VALUES
        -- January 2026
        (3, 1, 1, '2026-01-03 09:00:00', '2026-01-03 09:30:00', 5000.00, 'COMPLETED'),
        (3, 2, 1, '2026-01-05 10:00:00', '2026-01-05 10:20:00', 3000.00, 'COMPLETED'),
        (3, 3, 1, '2026-01-07 11:00:00', '2026-01-07 11:45:00', 7000.00, 'COMPLETED'),
        (3, 5, 1, '2026-01-10 10:00:00', '2026-01-10 12:00:00', 18000.00, 'COMPLETED'),
        (3, 1, 1, '2026-01-12 09:00:00', '2026-01-12 09:30:00', 5000.00, 'CANCELLED'),
        (3, 2, 1, '2026-01-14 10:00:00', '2026-01-14 10:20:00', 3000.00, 'COMPLETED'),
        (3, 3, 1, '2026-01-17 11:00:00', '2026-01-17 11:45:00', 7000.00, 'COMPLETED'),
        (3, 1, 1, '2026-01-20 09:00:00', '2026-01-20 09:30:00', 5000.00, 'COMPLETED'),
        (3, 5, 1, '2026-01-22 10:00:00', '2026-01-22 12:00:00', 18000.00, 'CANCELLED'),
        (3, 3, 1, '2026-01-25 11:00:00', '2026-01-25 11:45:00', 7000.00, 'COMPLETED'),
        -- February 2026
        (3, 1, 1, '2026-02-02 09:00:00', '2026-02-02 09:30:00', 5000.00, 'COMPLETED'),
        (3, 2, 1, '2026-02-04 10:00:00', '2026-02-04 10:20:00', 3000.00, 'COMPLETED'),
        (3, 5, 1, '2026-02-06 10:00:00', '2026-02-06 12:00:00', 18000.00, 'COMPLETED'),
        (3, 3, 1, '2026-02-09 11:00:00', '2026-02-09 11:45:00', 7000.00, 'CANCELLED'),
        (3, 1, 1, '2026-02-11 09:00:00', '2026-02-11 09:30:00', 5000.00, 'COMPLETED'),
        (3, 2, 1, '2026-02-13 10:00:00', '2026-02-13 10:20:00', 3000.00, 'COMPLETED'),
        (3, 3, 1, '2026-02-17 11:00:00', '2026-02-17 11:45:00', 7000.00, 'COMPLETED'),
        (3, 5, 1, '2026-02-19 10:00:00', '2026-02-19 12:00:00', 18000.00, 'COMPLETED'),
        (3, 1, 1, '2026-02-21 09:00:00', '2026-02-21 09:30:00', 5000.00, 'CANCELLED'),
        (3, 3, 1, '2026-02-24 11:00:00', '2026-02-24 11:45:00', 7000.00, 'COMPLETED'),
        -- March 2026
